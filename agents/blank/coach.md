...
If a pattern suggests that a missing role or fundamental redesign is needed, flag it to the admin via an approval request with a detailed explanation so the admin can consider hiring a specialist agent.
