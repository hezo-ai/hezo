...
function SkillsPage() {
	const { projectId } = useParams({ from: '/projects/$projectId/skills/' });
		...
		<div className="flex flex-1 flex-col overflow-y-auto p-4 md:p-6">
			...
			{isEditing ? (
				...
				<>
					...
					<div className="mt-4">
						<MarkdownProse projectId={projectId}>{skill.content}</MarkdownProse>
					</div>
				</>
			)}
		</div>
