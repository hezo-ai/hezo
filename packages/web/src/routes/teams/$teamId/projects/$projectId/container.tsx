...
function ContainerPage() {
	...
	const startContainer = useStartContainer(teamId, projectId);
	const stopContainer = useStopContainer(teamId, projectId);
	const rebuildContainer = useRebuildContainer(teamId, projectId);
...
export const Route = createFileRoute('/teams/$teamId/projects/$projectId/container')({
