...
function ProjectAssetsPage() {
	...
	const { data: assets, isLoading } = useProjectAssets(teamId, projectId);
	const upload = useUploadProjectAsset(teamId, projectId);
	const del = useDeleteProjectAsset(teamId, projectId);
...
export const Route = createFileRoute('/teams/$teamId/projects/$projectId/assets')({
