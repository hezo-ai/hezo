...
function GoalsPage() {
	...
	const archive = useArchiveGoal(teamId);
	...
	return (
		<div className="max-w-[900px] mx-auto w-full">
			...
			<GoalDialog teamId={teamId} open={createOpen} onOpenChange={setCreateOpen} />
			<GoalDialog
				teamId={teamId}
				goal={editGoal}
						...
						<div className="flex items-start justify-between gap-3">
							<div className="min-w-0 flex-1">
								...
								<div className="flex items-center gap-2 mt-1">
									<Badge color="neutral">
										{g.project_name ? `Project: ${g.project_name}` : 'Team-wide'}
									</Badge>
								</div>
							</div>
...
export const Route = createFileRoute('/teams/$teamId/goals/')({
	component: GoalsPage,
});
