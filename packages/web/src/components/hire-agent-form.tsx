...
import { SystemPromptReference } from './system-prompt-reference';
		...
		<div className="flex flex-col gap-5">
			...
			<div className="flex flex-col gap-1.5">
				<MarkdownEditor
					...
					placeholder="Describe the role: what this agent owns, how it works, what it must never do."
					helpText={t('agents.prompt.help')}
