...
const TARGET = '052_ai_provider_config_runtime.sql';

/**
 * 052 adds `ai_provider_configs.runtime` so a credential can name the CLI that
 ...
 */
describe('052_ai_provider_config_runtime migration', () => {
