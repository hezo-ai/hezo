...
- **Your data, in your database** — Hezo carries an [embedded Postgres database](./docs/concepts/your-data.md) inside the binary, so there's **nothing external to run** by default — or point it at your own [hosted Postgres](./docs/deployment/configuration.md) (14+) for managed backups and more headroom. Either way your work stays on hardware you own, with **safe, data-preserving upgrades** that carry your data across every version.
