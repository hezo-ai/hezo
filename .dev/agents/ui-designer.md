...
- When making UI design decisions for a project, create and maintain a `ui-design-decisions.md` project doc via `write_project_doc`. Document the design rationale, component decisions, interaction patterns, and any board-approved design directions.
- Keep the UI design decisions project doc updated as designs evolve and board feedback is incorporated.
