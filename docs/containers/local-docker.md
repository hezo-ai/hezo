...
The default. Agent containers run on the Docker daemon on the same machine as Hezo. No run
content - prompts, code, or output - leaves that machine except the traffic the agent itself
makes.
